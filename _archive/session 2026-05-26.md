...
**My request**:
Review the code and the documentation files.
As far as I can tell, `QUICK_REFERENCE.md`, `SESSION_HANDOFF.md`, and `NEW_SESSION_INIT.md` are the newest documentation files; confirm this.
Propose updating or removing any files that are out of date.
Note any inconsistencies or errors in files to be kept.
